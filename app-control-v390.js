...
(function(){
  ...
  function updateFooter(){const f=document.querySelector('.footer-note');if(f)f.textContent=`이앤엘 사고보고앱 v${VERSION} · TEST MODE`}
  if(typeof renderShell==='function'){const base=renderShell;renderShell=function(u){const r=base(u);injectHeader();updateFooter();return r}}
  setTimeout(()=>{try{if(currentUser())injectHeader();updateFooter()}catch(e){}},0);
})();
