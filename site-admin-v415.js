...
(function(){
  ...
  function installCss(){
    ...
    style.textContent=`
      ...
      .sa415-person-list{display:grid;gap:6px}.sa415-person{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,.7fr) minmax(0,1fr) auto;gap:8px;align-items:center;padding:9px 10px;border:1px solid #dce5ec;border-radius:9px;background:#fff}.sa415-person.inactive{opacity:.55}.sa415-person b{color:#254761}.sa415-person small{display:block;margin-top:3px;color:#76899a}.sa415-person .position{font-size:12px;font-weight:900;color:#275a7f}.sa415-person .phone{font-size:12px;color:#566f84;line-height:1.45}.sa415-person .email-on{display:block;color:#216747;font-weight:800}.sa415-person .email-off{display:block;color:#9a5b25;font-weight:800}.sa415-person .email-missing{display:block;color:#9b3e3e;font-weight:800}.sa415-person button{min-height:34px;border:1px solid #bdcbd7;border-radius:8px;background:#fff;font-weight:850}
