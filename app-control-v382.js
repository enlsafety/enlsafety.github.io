/* E&L Accident Report App v3.8.2 - Kakao-safe controller */
(function(){
  const VERSION='3.8.2';
  ...
  function stableUrl(){
    const u=new URL('stable382.html',location.href);
    u.searchParams.set('_ts',String(Date.now()));
    u.searchParams.set('v',VERSION);
    return u.toString();
  }
  function refreshNow(){
    try{location.replace(stableUrl())}catch(e){location.href='stable382.html?v='+encodeURIComponent(VERSION)}
  }
